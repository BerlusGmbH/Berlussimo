...
class StoreMietvertraegeRequest extends MietvertraegeRequest
{
    public function rules()
    {
        ...
        if ($v->valid()) {
            $units = DB::select("SELECT EINHEIT.EINHEIT_ID, TYP, EINHEIT_KURZNAME, IF(MIN(MIETVERTRAG_BIS) = '0000-00-00', MIN(MIETVERTRAG_BIS), MAX(MIETVERTRAG_BIS)) AS MIETVERTRAG_BIS 
                                 ...
                                 HAVING MIETVERTRAG_BIS != '0000-00-00'", [$this->get('unit')]);
