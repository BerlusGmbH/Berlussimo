...
$mieten->erstelle_formular ( "Hauptmen� -> Mietvertr�ge...", NULL );
$monat = sprintf ( '%02d', date ( "m" ) );
$jahr = date ( "Y" );
echo "<a href=\"?daten=mietvertrag_raus&mietvertrag_raus=mietvertrag_kurz\">Alle Mietvertr�ge</a>&nbsp;";
...
echo "<a href=\"?daten=mietvertrag_raus&mietvertrag_raus=letzte_auszuege\">Letzte Ausz�ge Objekt</a>&nbsp;<br>";
echo "<a href=\"?daten=mietvertrag_raus&mietvertrag_raus=letzte_einzuege\">Letzte Einz�ge Objekt</a>&nbsp;";
echo "<a href=\"?daten=mietvertrag_raus&mietvertrag_raus=alle_letzten_auszuege&monat=$monat&jahr=$jahr\">Alle Ausz�ge </a>&nbsp;";
echo "<a href=\"?daten=mietvertrag_raus&mietvertrag_raus=alle_letzten_einzuege&monat=$monat&jahr=$jahr\">Alle Einz�ge </a>&nbsp;";
...
// echo "<a href=\"?daten=mietvertrag_raus&mietvertrag_raus=mietvertrag_detailiert\">Mietvertr�ge im Detail</a>&nbsp;";
