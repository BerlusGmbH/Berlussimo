...
if(isset($_POST['einheit_ids']) && isset($_POST['druckdatum']) && isset($_POST['BTN_Netto'])){
	...
	$pdf->ezNewPage();
	$cols = array('EINHEIT'=>"Einheit",  'MIETER'=>"Mieter", 'ANSCHRIFT'=>"Anschrift", 'MEHR'=>"Erhö.", 'NEUE_MIETE'=>"Neue\nMiete", 'NK'=>"NK", 'HK'=>"HK", 'WM'=>"WM", 'N_ANSTIEG_DATUM'=>"ZUM");
	$pdf->ezTable($tab_ue,$cols,"Mieterhöhungen vom $druckdatum",
			array('showHeadings'=>1,'shaded'=>1, 'showLines'=>1, 'titleFontSize' => 11, 'fontSize' => 9, 'xPos'=>55,'xOrientation'=>'right',  'width'=>500,'cols'=>array('MEHR'=>array('justification'=>'right'),'WM'=>array('justification'=>'right'))));
