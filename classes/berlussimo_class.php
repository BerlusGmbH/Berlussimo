...
ORDER BY LPAD(EINHEIT_KURZNAME, LENGTH(EINHEIT_KURZNAME), '1') ASC ";
    ...
    function pdf_mietaufstellung($objekt_id) {
        ...
        if (is_array($arr)) {
            ...
            $cols = array('EINHEIT_KURZNAME1' => 'Einheit', 'TYP' => "Nutzung", 'MIETER' => 'Mieter', 'MIETER_SEIT' => 'Mieter seit', 'EINHEIT_QM_A' => 'Fläche m²', 'MIETE_KALT_QM_A' => 'Kaltmiete m²', 'MIETE_KALT_MON_A' => 'Kaltmiete Monat', 'UMLAGEN_A' => 'Nebenkosten');
            #	print_r($table_arr);
            #	die();
            ...
            $pdf -> ezTable($arr, $cols, "Mietaufstellung $monatsname $jahr", array('showHeadings' => 1, 'shaded' => 1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos' => 50, 'xOrientation' => 'right', 'width' => 500, 'cols' => array('EINHEIT_KURZNAME1' => array('justification' => 'left', 'width' => 55), 'TYP' => array('justification' => 'right', 'width' => 50), 'EINHEIT_QM_A' => array('justification' => 'right', 'width' => 50), 'MIETE_KALT_MON_A' => array('justification' => 'right', 'width' => 60), 'MIETER_SEIT' => array('justification' => 'right', 'width' => 50), 'MIETE_KALT_QM_A' => array('justification' => 'right', 'width' => 50), 'UMLAGEN_A' => array('justification' => 'right', 'width' => 55))));
    ...
    function pdf_mietaufstellung_m_j($objekt_id, $monat, $jahr) {
        ...
        if (is_array($arr)) {
            ...
            $cols = array('EINHEIT_KURZNAME1' => 'Einheit', 'TYP' => "Nutzung", 'MIETER' => 'Mieter', 'MIETER_SEIT' => 'Mieter seit', 'EINHEIT_QM_A' => 'Fläche m²', 'MIETE_KALT_QM_A' => 'Kaltmiete m²', 'MIETE_KALT_MON_A' => 'Kaltmiete Monat', 'UMLAGEN_A' => 'Nebenkosten', 'MIETE_BRUTTO' => 'BruttoM', 'MWST' => 'MWSt', 'ZAHLUNGEN' => 'Zahlung');
            #	print_r($table_arr);
            #	die();
            ...
            if (!isset($_REQUEST['xls'])) {
                $pdf -> ezTable($arr, $cols, "$oo->objekt_kurzname - Mietaufstellung $monatsname $jahr", array('showHeadings' => 1, 'shaded' => 1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos' => 50, 'xOrientation' => 'right', 'width' => 750, 'cols' => array('EINHEIT_KURZNAME1' => array('justification' => 'left', 'width' => 55), 'TYP' => array('justification' => 'right', 'width' => 50), 'EINHEIT_QM_A' => array('justification' => 'right', 'width' => 50), 'MIETE_KALT_MON_A' => array('justification' => 'right', 'width' => 60), 'MIETER_SEIT' => array('justification' => 'right', 'width' => 50), 'MIETE_KALT_QM_A' => array('justification' => 'right', 'width' => 50), 'UMLAGEN_A' => array('justification' => 'right', 'width' => 55))));
...
ORDER BY OBJEKT_KURZNAME, HAUS_STRASSE, HAUS_NUMMER, EINHEIT_LAGE";
        $cols = array('OBJEKT_KURZNAME' => "Objekt", 'HAUS_STRASSE' => "Strasse", 'HAUS_NUMMER' => 'Nr', 'EINHEIT_KURZNAME' => 'Einheit', 'TYP' => 'Typ', 'EINHEIT_LAGE' => 'Lage', 'EINHEIT_QM' => 'Fl�che m�', 'MIETER' => 'Mieterinfos', 'MIETER' => 'Mieter', 'KONTAKT' => 'Kontakt');
        #	print_r($table_arr);
        #	die();
...
WHERE RECHNUNGEN.BELEG_NR = RECHNUNGEN_POSITIONEN.BELEG_NR && RECHNUNGEN.AKTUELL='1' && RECHNUNGEN_POSITIONEN.AKTUELL='1' GROUP BY RECHNUNGEN.BELEG_NR ASC");
    ...
    function haeuser_vom_objekt_im_pool($objekt_id) {
        ...
        if (is_array($haeuser_arr)) {
            ...
            foreach ($haeuser_arr as $key => $value) {$haeuser_arr_sortiert[] = $value;
            }
