...
#die();
		if($lang=='en'){
		$cols = array('MIETER_SALDO'=>"Saldo", 'EIGENTUEMER_NAMEN'=>"owner", 'EINHEIT_KURZNAME'=>"apart.No",'MIETER'=>'tenant','WEG-FLAECHE_A'=>'size m²','BRUTTO_SOLL_A'=>'to cash g.','BRUTTO_IST_A'=>'paid g.', 'DIFF_A'=>'diff.', 'NETTO_SOLL_A'=>'net rent', 'ABGABE_IHR_A'=>'for maint.', 'ABGABE_HV_A'=>'mng. Fee', 'SUMME_REP_A'=>'maint. bills', 'ENDSUMME_A'=>'pay off');
		$pdf->ezTable($pdf_tab,$cols,"<b>$monat_name $jahr - Overview - $ein_nam</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));	
		}else{
		...
		$pdf->ezTable($pdf_tab,$cols,"<b>$monat_name $jahr - Gesamtübersicht - $ein_nam</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>30,'xOrientation'=>'right',  'width'=>550,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));		
		}
...
#$uebersicht[$a]['ZWISCHEN']
		if($lang=='en'){
		$cols = array('EIGENTUEMER_NAMEN'=>"owner", 'EINHEIT_KURZNAME'=>"apart.No",'MIETER'=>'tenant', 'WEG-FLAECHE_A'=>'size m²', 'NETTO_SOLL_A'=>'net rent',  'ABGABE_IHR_A'=>'for maint.', 'ABGABE_HV_A'=>'mng. fee', 'ENDSUMME_A'=>'transfer');
		$pdf->ezTable($pdf_tab,$cols,"<b>$monat_name $jahr - Overview - $ein_nam</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));	
		}else{
		$cols = array('EIGENTUEMER_NAMEN'=>"Eigentümer", 'EINHEIT_KURZNAME'=>"EINHEIT",'MIETER'=>'Mieter','WEG-FLAECHE_A'=>'Eig. m²','BRUTTO_SOLL_A'=>'Warm SOLL','BRUTTO_IST_A'=>'Warm IST', 'DIFF_A'=>'DIFF', 'NETTO_SOLL_A'=>'rent p.m.\n (actual)', 'ABGABE_IHR_A'=>'IHR', 'ABGABE_HV_A'=>'HV', 'SUMME_REP_A'=>'Rep.', 'ENDSUMME_A'=>'AUSZAHLUNG');	
...
if($lang=='en'){
	$cols = array('EINHEIT_KURZNAME'=>"Apt", 'EINHEIT_QM_A'=>'MVm²', 'WEG-FLAECHE_A'=>'m²','EIGENTUEMER_NAMEN'=>"Own", 'MIETER'=>"Tenant", 'MIETER_SALDO_A'=>'current', 'NETTO_SOLL_G_A'=>"Garanty", 'NETTO_SOLL_A'=>"net rent", 'NETTO_SOLL_DIFF_A'=>"diff", 'ABGABE_HV_A'=>"fee", 'ABGABE_IHR'=>"for maint.", 'ENDSUMME_A'=>"Amount", 'SUMME_REP_A'=>'Rep.');
}
...
if($lang=='en'){
		...
		$cols = array('EIGENTUEMER_NAMEN'=>"<b>owner</b>", 'EINHEIT_KURZNAME'=>"<b>apart.No</b>",'MIETER'=>"<b>tenant</b>", 'WEG-FLAECHE_A'=>"<b>size [m²]</b>", 'NETTO_SOLL_A'=>"<b>net rent [€]</b>",  'ABGABE_IHR_A'=>"<b>for maint. [€]</b>", 'ABGABE_HV_A'=>"<b>mng. fee [€]</b>", 'ENDSUMME_A'=>"<b>Amount [€]</b>");
		$pdf->ezTable($pdf_tab,$cols,"<b>Monthly report $monat/$jahr    $ein_nam</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));	
		}else{
		$cols = array('EIGENTUEMER_NAMEN'=>"<b>Eigentümer</b>", 'EINHEIT_KURZNAME'=>"<b>apart.No</b>",'MIETER'=>"<b>tenant</b>", 'WEG-FLAECHE_A'=>"<b>size [m²]</b>", 'NETTO_SOLL_A'=>"<b>net rent [€]</b>",  'ABGABE_IHR_A'=>"<b>for maint. [€]</b>", 'ABGABE_HV_A'=>"<b>mng. fee [€]</b>", 'ENDSUMME_A'=>"<b>Amount [€]</b>");	
		$pdf->ezTable($pdf_tab,$cols,"<b>$monat_name $jahr - Gesamtübersicht - $ein_nam</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>30,'xOrientation'=>'right',  'width'=>550,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));		
		}
...
$cols = array('TEXT'=>"", 'AM'=>"");
$pdf->ezTable($trans_tab, $cols, "<b>Summary $monat/$jahr</b>", array('showHeadings'=>0,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>235,'xOrientation'=>'right',  'width'=>500, 'cols'=>array('TEXT'=>array('justification'=>'right', 'width'=>250), 'AM'=>array('justification'=>'right', 'width'=>65))));
unset($trans_tab);
...
if($lang=='en'){
	$cols = array('EINHEIT_KURZNAME'=>"Apt", 'EINHEIT_QM_A'=>'MVm²', 'WEG-FLAECHE_A'=>'m²','EIGENTUEMER_NAMEN'=>"Own", 'MIETER'=>"Tenant", 'MIETER_SALDO_A'=>'current', 'NETTO_SOLL_G_A'=>"Garanty", 'NETTO_SOLL_A'=>"net rent", 'NETTO_SOLL_DIFF_A'=>"diff", 'ABGABE_HV_A'=>"fee", 'ABGABE_IHR'=>"for maint.", 'ENDSUMME_A'=>"Amount", 'SUMME_REP_A'=>'Rep.', 'TRANSFER_A'=>'transfer');
}
...
if($lang=='en'){
		...
		$cols = array('EIGENTUEMER_NAMEN'=>"<b>owner</b>", 'EINHEIT_KURZNAME'=>"<b>apart.No</b>",'MIETER'=>"<b>tenant</b>", 'WEG-FLAECHE_A'=>"<b>size [m²]</b>", 'NETTO_SOLL_A'=>"<b>net rent [€]</b>",  'ABGABE_IHR_A'=>"<b>for maint. [€]</b>", 'ABGABE_HV_A'=>"<b>mng. fee [€]</b>", 'ENDSUMME_A'=>"<b>Amount [€]</b>");
		$pdf->ezTable($pdf_tab,$cols,"<b>Monthly report $w_monat/$w_jahr    $ein_nam, $anschrift</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));	
		}else{
		#$pdf->ezText($pdf_tab[$a]['ANSCHRIFT'], 11);
		$anschrift = $pdf_tab[$a]['ANSCHRIFT'];
			$cols = array('EIGENTUEMER_NAMEN'=>"<b>Eigentümer</b>", 'EINHEIT_KURZNAME'=>"<b>apart.No</b>",'MIETER'=>"<b>tenant</b>", 'WEG-FLAECHE_A'=>"<b>size [m²]</b>", 'NETTO_SOLL_A'=>"<b>net rent [€]</b>",  'ABGABE_IHR_A'=>"<b>for maint. [€]</b>", 'ABGABE_HV_A'=>"<b>mng. fee [€]</b>", 'ENDSUMME_A'=>"<b>Amount [€]</b>");	
		$pdf->ezTable($pdf_tab,$cols,"<b>$monat_name $jahr - Gesamtübersicht - $ein_nam, $anschrift</b>",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>30,'xOrientation'=>'right',  'width'=>550,'cols'=>array('ENDSUMME_A'=>array('justification'=>'right', 'width'=>50), 'EIGENTUEMER_NAMEN'=>array('justification'=>'left', 'width'=>50))));		
		}
...
if($lang=='en'){
	$cols = array('EINHEIT_KURZNAME'=>"Apt",  'WEG-FLAECHE_A'=>'m²','EIGENTUEMER_NAMEN'=>"Own", 'MIETER'=>"Tenant", 'MIETER_SALDO_VM'=>'VM','MIETER_SALDO_A'=>'current', 'NETTO_SOLL_G_A'=>"Garanty", 'NETTO_SOLL_A'=>"net rent", 'NETTO_SOLL_DIFF_A'=>"diff", 'ABGABE_HV_A'=>"fee", 'ABGABE_IHR'=>"for maint.", 'ENDSUMME_A'=>"Amount", 'SUMME_REP_A'=>'Rep.', 'TRANSFER_A'=>'transfer');
}else{
	$cols = array('EINHEIT_KURZNAME'=>"Apt",  'WEG-FLAECHE_A'=>'m²','EIGENTUEMER_NAMEN'=>"Own", 'MIETER'=>"Tenant", 'MIETER_SALDO_A'=>'current', 'NETTO_SOLL_G_A'=>"Garanty", 'NETTO_SOLL_A'=>"net rent", 'NETTO_SOLL_DIFF_A'=>"diff", 'ABGABE_HV_A'=>"fee", 'ABGABE_IHR'=>"for maint.", 'ENDSUMME_A'=>"Amount", 'SUMME_REP_A'=>'Rep.', 'TRANSFER_A'=>'transfer');
}
...
function saldo_berechnung_et_DOBARpravo_pdf(&$pdf, $einheit_id){
	...
	$cols = array('Z'=>Z, 'MV_ID'=>MV, 'MMJJJJ'=>MONAT2,'N_TAG'=>N_TAG, 'TAGE'=>TAGE, 'G'=>G,  'LEER'=>LEER, 'WM_SOLL'=>WM_SOLL, 'MWST_S'=>MWST_S, 'NK'=>NK, 'M_ZB'=>M_ZB, 'M_ERG'=>M_ERG,'M_SVM'=>M_SVM, 'MIETER'=>MIETER, 'GM'=>GM, 'KM_S'=>KM_S, 'GM_D_S'=>GM_D_S, 'FIX_S'=>FIX_S, 'KM_I'=>KM_I, 'INS_ANT'=>INS_ANT, 'INS_ANTR'=>INS_R, 'INS_GARANTY'=>INS_GARANTY, 'HINWEIS'=>CODE);
	
	for($et=0;$et<$anz_et;$et++){
		$pdf->ezText("$e->einheit_kurzname",14);
		$pdf->ezTable($this->pdf_tab_g[$et], $cols, EINNAHMEN_REPORT." $weg->eigentuemer_von $datum_bis" , array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 10, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>750, 'cols'=>array('IHR'=>array('justification'=>'right'), 'HV'=>array('justification'=>'right'), 'REP'=>array('justification'=>'right'), 'AUSZAHLUNG'=>array('justification'=>'right'))));
	}
	#ob_clean(); //ausgabepuffer leeren
	#header("Content-type: application/pdf");  // wird von MSIE ignoriert
	#$pdf->ezStream();
...
for($et=0;$et<$anz_et;$et++){
	...
	$cols = array('MMJJJJ'=>MONAT2,'N_TAG'=>N_TAG, 'TAGE'=>TAGE, 'G'=>G,  'LEER'=>LEER, 'WM_SOLL'=>WM_SOLL, 'MWST_S'=>MWST_S, 'NK'=>NK, 'M_ZB'=>M_ZB, 'M_ERG'=>M_ERG,'M_SVM'=>M_SVM, 'MIETER'=>MIETER, 'GM'=>GM, 'KM_S'=>KM_S, 'GM_D_S'=>GM_D_S, 'FIX_S'=>FIX_S, 'KM_I'=>KM_I, 'INS_ANT'=>INS_ANT, 'INS_ANTR'=>INS_R, 'HINWEIS'=>CODE);
...
function pdf_income_reports2($objekt_id, $jahr=null){
	...
	if(is_array($ein_arr)){
			...
			$cols = array('MON'=>MONAT2,'WM_SOLL'=>WM, 'NK_SOLL'=>NK, 'ZB_M'=>'ZB_M','SALDO_M'=>'SALDO_M',  'KM_SOLL'=>KM_SOLL, 'KM_IST'=>KM_IST, 'GARANTY_KM'=>GARANTIE_KM,  'KM_INS_DIFF'=>INS_DIFF_KM, 'IHR'=>'IHR', 'HV'=>'HV','REP'=>'REP', 'INSMG'=>'INS MG', 'KOST_ALLE'=>'KOST ALLE', 'K4180'=>'4180', 'K4280'=>'4280', 'K4281'=>'4281', 'K4282'=>'4282', 'K5081'=>'VZN', 'K5010'=>'EINZAHLUNG', 'HG_Z'=>'HG ZAHLUNG','SOLL_AUSZ'=>'AUSZ SOLL', 'AUSZAHLUNG'=>'AUSZAHLUNG IST', 'SALDO_MET'=>'SALDO M', 'PERIOD'=>'PERIOD', 'INS_DIFF'=>'INS_DIFF');	
			}else{
			$cols = array('MON'=>MONAT2,'WM_SOLL'=>WM, 'NK_SOLL'=>NK, 'ZB_M'=>'ZB_M','SALDO_M'=>'SALDO_M',  'KM_SOLL'=>KM_SOLL, 'KM_IST'=>KM_IST,  'KOST_ALLE'=>'KOST ALLE', 'K5081'=>'VZN', 'K5010'=>'EINZAHLUNG', 'HG_Z'=>'HG ZAHLUNG','SOLL_AUSZ'=>'AUSZ SOLL', 'AUSZAHLUNG'=>'AUSZAHLUNG IST', 'SALDO_MET'=>'SALDO M', 'PERIOD'=>'PERIOD');
			}
			$pdf->ezTable($pdf_tab, $cols, EINNAHMEN_REPORT." $datum_von $datum_bis" , array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 10, 'fontSize' => 6, 'xPos'=>50,'xOrientation'=>'right',  'width'=>750, 'cols'=>array('IHR'=>array('justification'=>'right'), 'HV'=>array('justification'=>'right'), 'REP'=>array('justification'=>'right'), 'AUSZAHLUNG'=>array('justification'=>'right'))));
			unset($pdf_tab);
			$pdf->ezNewPage();
			#print_r($weg);
			#}	
