...
$this->kontostand_tagesgenau_bis($geldkonto_id, $datum_m_danach_2);
	...
	$cols = array('DATUM'=>"Datum", 'G_BUCHUNGSNUMMER'=>"BNR",'AUSZUG'=>"Auszug",'KONTO'=>"Konto"
,'BETRAG'=>'Betrag','MWST_ANTEIL'=>'MWSt-Anteil','KOSTENTRAEGER_BEZ'=>'Zuordnung','VERWENDUNGSZWECK'=>'Buchungstext', 'PLATZ'=>'Hinweis');
	
$pdf->ezTable($table_arr,$cols,"Buchungsjournal $monatsname $pdf_jahr $gk->geldkonto_bezeichnung",
array('showHeadings'=>1,'shaded'=>0, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('DATUM'=>array('justification'=>'right', 'width'=>50),'G_BUCHUNGSNUMMER'=>array('justification'=>'right', 'width'=>30), 'BETRAG'=>array('justification'=>'right','width'=>50),'KOSTENTRAEGER_BEZ'=>array('justification'=>'left','width'=>75),'KONTO'=>array('justification'=>'right','width'=>30),'AUSZUG'=>array('justification'=>'right','width'=>35),'PLATZ'=>array('justification'=>'left','width'=>50))));
...
$this->kontostand_tagesgenau_bis($geldkonto_id, $datum_m_danach);
	...
	$cols = array('DATUM'=>"Datum", 'G_BUCHUNGSNUMMER'=>"BNR",'AUSZUG'=>"Auszug",'KONTO'=>"Konto"
,'BETRAG'=>'Betrag','MWST_ANTEIL'=>'MWSt','KOSTENTRAEGER_BEZ'=>'Zuordnung','VERWENDUNGSZWECK'=>'Buchungstext', 'PLATZ'=>'Hinweis');
	
$pdf->ezTable($table_arr,$cols,"Buchungsjournal $ja $gk->geldkonto_bezeichnung",
array('showHeadings'=>1,'shaded'=>0, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('DATUM'=>array('justification'=>'right', 'width'=>50),'G_BUCHUNGSNUMMER'=>array('justification'=>'right', 'width'=>30), 'BETRAG'=>array('justification'=>'right','width'=>50),'KOSTENTRAEGER_BEZ'=>array('justification'=>'left','width'=>75),'KONTO'=>array('justification'=>'right','width'=>30),'AUSZUG'=>array('justification'=>'right','width'=>35),'PLATZ'=>array('justification'=>'left','width'=>50))));
...
$link = "?daten=buchen&option=konten_uebersicht";
	...
	include_once('classes/class_bpdf.php');
		...
		$monatname = monat2name($monat);
			$pdf->ezText("<u>Buchungskontenübersicht $monatname $jahr</u>", 12, array('justification'=>'center'));
		}else{
			$pdf->ezText("<u>Buchungskontenübersicht $jahr</u>", 11, array('justification'=>'center'));
			}
...
$cols = array('DATUM'=>"Datum", 'KONTO_AUSZUGSNUMMER'=>"AUSZUG", 'G_BUCHUNGSNUMMER'=>"BNR"
,'BETRAG'=>'Betrag','MWST_ANTEIL'=>'MWSt-Anteil','KOS_BEZ'=>'Zuordnung','VERWENDUNGSZWECK'=>'Buchungstext');
#	print_r($table_arr);
#	die();
$pdf->ezTable($table_arr,$cols,"<b>Buchungskonto $kostenkonto - $k->konto_bezeichnung</b>",
...
$pdf->ezTable($tab_arr,$cols,"Monatsbericht ohne Auszug - Objekt:$objekt_name - $monatname $jahr",
...
$cols = array('EINHEIT'=>"<b>EINHEIT</b>", 'MIETER'=>"<b>MIETER</b>",'SALDO_VM'=>"<b>SALDO\nVORMONAT</b>", 'SOLL_WM'=>"<b>SOLL\nMIETE\nWARM</b>", 'UMLAGEN'=>"<b>DAVON\nUMLAGEN</b>", 'G_SOLL_AKT'=>"<b>GESAMT\nSOLL\nAKTUELL</b>",'ZAHLUNGEN'=>"<b>GELEISTETE\nZAHLUNGEN</b>", 'MWST'=>"<b>DAVON\nMWST</b>", 'ERG'=>"<b>SALDO\nNEU</b>");
		$pdf->ezTable($tab_arr,$cols,"Monatsbericht mit Auszug - Objekt:$objekt_name - $monatname $jahr",
array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 10, 'fontSize' => 8, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'rowGap'=>1, 'cols'=>array('EINHEIT'=>array('justification'=>'left', 'width'=>50), 'SALDO_VM'=>array('justification'=>'right', 'width'=>60), 'UMLAGEN'=>array('justification'=>'right', 'width'=>55), 'G_SOLL_AKT'=>array('justification'=>'right', 'width'=>50), 'ZAHLUNGEN'=>array('justification'=>'right','width'=>65), 'MWST'=>array('justification'=>'right'), 'ERG'=>array('justification'=>'right','width'=>50))));
...
function finde_buchungen_pdf($abfrage){
	...
	include_once('classes/class_bpdf.php');
		...
		$pdf->ezTable($table_arr,$cols,"$ueberschrift",
