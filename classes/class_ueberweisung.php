...
#$dtaus = new  dtaus_berlus; //nach oben gewandert wegen umrüche entfernen
$monat = date("m");
$jahr = date("Y");
...
function pdf_dtaus_datei_uebersicht($dtaus_id){
	...
	if(!is_array($zeilen_arr)){
		fehlermeldung_ausgeben("DTAUS DATEI FEHLERHAFT, KEINE DATEN IN DER DATENBANK");
			...
			$pdf->ezTable($zeilen_arr,$cols,"<b>Übersicht DTAUS</b>",
			array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>30,'xOrientation'=>'right',  'width'=>550,'cols'=>array('BETRAG'=>array('justification'=>'right', 'width'=>50), 'DATUM'=>array('justification'=>'left', 'width'=>50))));
