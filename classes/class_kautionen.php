...
function kautionsberechnung_pdf($kostentraeger_typ, $kostentraeger_id, $datum_bis, $zins_pj, $kap_prozent, $soli_prozent){
	...
	$cols = array('DATUM'=>"Einzahlung", 'BETRAG'=>"Betrag",'ZINSTAGE'=>"Zinstage", 'AUSZAHLUNG'=>"Auszahlung", 'BETRAG_VERZINST'=>"Verzinst bis $datum_bis_a ($zins_pj%)", 'VERWENDUNGSZWECK'=>"Buchungstext",'KAP'=>"KAP $kap_prozent%",'SOLI'=>"Soli $soli_prozent %", 'BETRAG_REIN'=>"Auszahlung");
	...
	$pdf->ezTable($table_arr,$cols,"Kautionsberechnung $mv->einheit_kurzname $mv->personen_name_string",
array('showHeadings'=>1,'shaded'=>0, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('DATUM'=>array('justification'=>'right', 'width'=>50),'BETRAG'=>array('justification'=>'right', 'width'=>50), 'VERWENDUNGSZWECK'=>array('justification'=>'right'))));
