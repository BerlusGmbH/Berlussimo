...
WHERE KONTENRAHMEN_GRUPPEN.BEZEICHNUNG = '$gruppenbez' ORDER BY `KONTENRAHMEN_KONTEN`.`KONTO` ASC");
    ...
    function pdf_uebersicht_profil($pdf, $profil_id) {
        ...
        $pdf -> ezTable($table_arr, $cols, "Profil�bersicht $this->bk_bezeichnung $this->bk_kos_bez $this->bk_jahr", array('showHeadings' => 1, 'shaded' => 1, 'titleFontSize' => 8, 'fontSize' => 7, 'xPos' => 50, 'xOrientation' => 'right', 'width' => 500));
        ...
        if ($empf_kos_typ == 'MIETVERTRAG') {
            ...
            if (isset($this -> bk_an_dat)) {
                ...
                if ($mv -> mietvertrag_aktuell) {
                    ...
                    $pdf -> ezTable($anp_tab, $cols, "Anpassungstabelle", array('showHeadings' => 1, 'shaded' => 1, 'titleFontSize' => 7, 'fontSize' => 7, 'xPos' => 55, 'xOrientation' => 'right', 'width' => 500, 'cols' => array('AKTUELL' => array('justification' => 'right', 'width' => 100), 'ANPASSUNG' => array('justification' => 'right', 'width' => 100), 'NEU' => array('justification' => 'right', 'width' => 100))));
                    $pdf -> ezSetDy(-15);
