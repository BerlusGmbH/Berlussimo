    ...
    function vorlage_waehlen($empf_typ = null, $kat = null)
    {
        ...
        if ($numrows) {
            ...
            while ($row = mysql_fetch_assoc($result)) {
                ...
                $text = $row ['TEXT'];
                $kat = $row ['KAT'];
                $link_erstellen = "<a href=\"?daten=bk&option=serienbrief_pdf&vorlagen_dat=$dat&emailsend\">Serienbrief in mehreren PDFs</a>";
                $link_ansehen = "<a href=\"?daten=bk&option=serienbrief_pdf&vorlagen_dat=$dat\">Serienbrief in einem PDF</a>";
