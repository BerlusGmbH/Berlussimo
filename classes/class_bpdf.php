...
function pdf_heizungabnahmeprotokoll($pdf, $mv_id, $einzug=null){
	$mv = new mietvertraege();
	$mv->get_mietvertrag_infos_aktuell($mv_id);
	$pdf->ezText("<b>Wohnungs-Nr:</b> $mv->einheit_kurzname",10, array('justification'=>'right'));
	...
	$cols = array('RAUM'=>"Raum", 'GERAET_NR'=>"Geräte-Nr.",'ALT'=>"M-WERT(alt)",'NEU'=>"IST-WERT(neu)");
	...
	$pdf->ezTable($tab,$cols,"$title",
			array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 10, 'fontSize' => 9, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('DATUM'=>array('justification'=>'right', 'width'=>50),'G_BUCHUNGSNUMMER'=>array('justification'=>'right', 'width'=>30), 'BETRAG'=>array('justification'=>'right','width'=>50),'KOSTENTRAEGER_BEZ'=>array('justification'=>'left','width'=>75),'KONTO'=>array('justification'=>'right','width'=>30),'AUSZUG'=>array('justification'=>'right','width'=>35),'PLATZ'=>array('justification'=>'left','width'=>50))));
	...
	$cols = array('RAUM'=>"Wasser", 'GERAET_NR'=>"Zähler-Nr.",'ALT'=>"Stand",'NEU'=>"Eichdatum !!!");
	$pdf->ezTable($tabw,$cols,"$title1",
			array('showHeadings'=>1,'shaded'=>1, 'titleFontSize' => 10, 'fontSize' => 9, 'xPos'=>50,'xOrientation'=>'right',  'width'=>500,'cols'=>array('DATUM'=>array('justification'=>'right', 'width'=>50),'G_BUCHUNGSNUMMER'=>array('justification'=>'right', 'width'=>30), 'BETRAG'=>array('justification'=>'right','width'=>50),'KOSTENTRAEGER_BEZ'=>array('justification'=>'left','width'=>75),'KONTO'=>array('justification'=>'right','width'=>30),'AUSZUG'=>array('justification'=>'right','width'=>35),'PLATZ'=>array('justification'=>'left','width'=>50))));
...
function pdf_abnahmeprotokoll($pdf, $mv_id, $einzug=null){
	...
	$pdf->ezText('_____ Zimmer           Küche/Kochnische           Wannenbad/Dusche           extra WC           Abstellraum',10, array('justification'=>'left'));
	$pdf->ezSetDy(-15);//Abstand
	$pdf->ezText('_____ Balkon/Loggia    _____ Keller-Nr: ___________________',10, array('justification'=>'left'));
	$pdf->ezSetDy(-15);//Abstand
	$pdf->ezText("<b>Beheizung:</b>",10, array('justification'=>'left'));
	...
	$pdf->ezSetDy(-15);//Abstand
	$pdf->ezText("<b>Warmwasser:</b>",10, array('justification'=>'left'));
	$pdf->rectangle(120,$pdf->y-2,10,10);
	...
	$pdf->ezSetDy(-15);//Abstand
	$y_e = $pdf->y;
	$pdf->ezText("<b>Elektrik-Zähler:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-5);//Abstand
	
	$pdf->ezText("<b>Zähler-Nr.:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-5);//Abstand
	$this->kasten($pdf, 10, 120, 15, 15);
	
	
	$pdf->ezText("<b>Stand</b>",10, array('justification'=>'left'));
	...
	$pdf->ezText("<b>Gas-Zähler:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-5);//Abstand
	...
	$pdf->ezSetMargins(135,70,50,50);
	$pdf->ezSetDy(-10);//Abstand
	$pdf->ezText("Der Mieter stimmt zu, dass der Vermieter die Zählerstände unter Angabe von Vor- und Zuname, sowie der Verzugsanschrift an den regionalen Versorger meldet.",9, array('justification'=>'left'));
	$pdf->ezSetDy(-10);//Abstand
	$pdf->ezText("<b>Bei der Wohnungsabnahme wurde festgestellt:</b>",10, array('justification'=>'left'));
	$pdf->ezSetMargins(135,70,330,50);
	$pdf->ezSetDy(12);//Zurück
	$pdf->ezText("<b>Beseitigung erfolgt durch:</b>",10, array('justification'=>'left'));
	
	$pdf->ezSetMargins(135,70,50,50);
	
	$pdf->ezSetDy(-5);//Abstand
	$pdf->ezText("<b>Wohnungsflur:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>Küche:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>Bad:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>Wohnzimmer:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezNewPage();
	$pdf->ezText("<b>Schlafzimmer:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>1. Kinderzimmer:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>2. Kinderzimmer:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>3. Kinderzimmer:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("<b>Balkon/Loggia/Sonstiges:</b>",10, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
	...
	$pdf->ezText("______ Haustür-/ Zentralschlüssel",9, array('justification'=>'left'));
	$pdf->ezSetMargins(135,70,50,50);
	$pdf->ezText("______ Wohnungstür   ______ Briefkasten   ______ Keller   ______ Sonstige _____________________________________",9, array('justification'=>'left'));
	...
	$pdf->ezSetMargins(135,70,50,50);
	$pdf->ezSetDy(-5);//Abstand
	$pdf->ezText("<b>Die gezahlte Kaution kann ausgezahlt werden</b>",9, array('justification'=>'left'));
	$pdf->ezSetDy(-3);//Abstand
	$this->kasten($pdf, 2, 250, 10, 10, 50);
	$pdf->addText(270,$pdf->y+2,9,"<b>JA</b>");
	$pdf->addText(335,$pdf->y+2,9,"<b>NEIN</b>");
	$pdf->ezSetDy(-5);//Abstand
	$pdf->ezText("IBAN:__________________________________  BIC:_________________  BANKNAME:___________________________",9, array('justification'=>'left'));
	$pdf->ezSetDy(-5);//Abstand
	$pdf->ezText("Verzugsanschrift: ____________________________________________________________________________________",9, array('justification'=>'left'));
	$pdf->ezSetDy(-5);//Abstand
	$pdf->ezText("Telefon und E-Mail: __________________________________________________________________________________",9, array('justification'=>'left'));
	$pdf->ezSetDy(-20);//Abstand
