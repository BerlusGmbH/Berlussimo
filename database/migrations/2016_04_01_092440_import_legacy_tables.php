...
class ImportLegacyTables extends Migration
{
  ...
  `KOSTENTRAEGER_TYP` varchar(30) NOT NULL,
...
(2, 0, 1, '*', '1');"
  ...
  `KONTO_BEZ` varchar(100) NOT NULL,
  ...
  `B_ID` int(7) NOT NULL,
  `EMPF` varchar(255) NOT NULL,
  `ZEITRAUM` varchar(255) NOT NULL,
  `MIETERNUMMER` varchar(100) NOT NULL,
  ...
  `G_KOSTEN` decimal(10,2) NOT NULL,
  `G_HNDL` decimal(10,2) NOT NULL,
  `VERTEILER` varchar(50) NOT NULL,
  `IHRE_ME` varchar(50) NOT NULL,
  ...
  `GKEY_NAME` varchar(50) NOT NULL,
  `G_VAR` varchar(30) NOT NULL,
  `E_VAR` varchar(20) NOT NULL,
...
(5, 'Nach Aufzugsprozent ', 'g_aufzug_prozent', 'e_aufzug_prozent', '%', '1') ;"
  ...
  `DETAIL_INHALT` varchar(400) NOT NULL,
  `DETAIL_BEMERKUNG` varchar(400) NOT NULL,
  `DETAIL_AKTUELL` enum('0','1') NOT NULL,
  `DETAIL_ZUORDNUNG_TABELLE` varchar(50) NOT NULL,
  `DETAIL_ZUORDNUNG_ID` varchar(6) NOT NULL,
...
(1, 1, 'Geschlecht', 'männlich', 'admin-18.11.2015 12:55', '1', 'Person', '1'),
(2, 2, 'Telefon', '030 89 78 44 77', 'Stand 18.11.2015', '1', 'Person', '1'),
(3, 3, 'Email', 'software@hausverwaltung.de', 'Stand 18.11.2015', '1', 'Person', '1'),
(4, 4, 'Zustellanschrift', 'Max Mustermann\r\nc/o BerlusGmbH\r\nMustermannstrasse1\r\n<b>14055 Berlin</b>', '', '1', 'Person', '1'),
(5, 5, 'Telefon', '030 89 78 44 77', 'admin 18.11.2015 13:07:14', '1', 'Partner', '1'),
(6, 6, 'Fax', '030 89 78 44 79', 'admin 18.11.2015 13:07:14', '1', 'Partner', '1'),
(7, 7, 'Email', 'software@hausverwaltung.de', 'admin 18.11.2015 13:07:14', '1', 'Partner', '1');"
            );
        }
  ...
  `DETAIL_KAT_NAME` varchar(100) NOT NULL,
  `DETAIL_KAT_KATEGORIE` varchar(30) NOT NULL,
  `DETAIL_KAT_AKTUELL` enum('0','1') NOT NULL,
...
(173, 'Kabelnutzung ', 'Einheit', '1');"
  ...
  `UNTERKATEGORIE_NAME` varchar(100) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
...
(68, 172, 'NEIN', '1');"
  ...
  `EINHEIT_LAGE` varchar(50) NOT NULL,
  `HAUS_ID` int(11) NOT NULL,
  `EINHEIT_AKTUELL` enum('0','1') NOT NULL,
  `EINHEIT_KURZNAME` varchar(50) NOT NULL,
  `TYP` enum('Wohnraum','Gewerbe','Stellplatz','Garage','Keller','Freiflaeche','Wohneigentum','Werbeflaeche','Kinderwagenbox','Zimmer (möbliert)') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `FOOTER_TYP` varchar(50) NOT NULL,
  `FOOTER_TYP_ID` int(6) NOT NULL,
  `ZAHLUNGSHINWEIS` mediumtext,
  `ZEILE1` varchar(200) NOT NULL,
  `ZEILE2` varchar(200) NOT NULL,
  ...
  `BEGUENSTIGTER` varchar(100) NOT NULL,
...
(1, 1, 1, 'Partner', 1, '1');"
  ...
  `ERFASS_NR` varchar(20) DEFAULT NULL,
...
(8, 8, 'Maurer', '1');"
  ...
  `HAUS_ID` int(11) NOT NULL,
  `HAUS_STRASSE` varchar(200) NOT NULL,
  `HAUS_NUMMER` varchar(10) NOT NULL,
  `HAUS_STADT` varchar(200) NOT NULL,
  `HAUS_PLZ` int(11) NOT NULL,
  `HAUS_QM` decimal(10,2) NOT NULL,
  `HAUS_AKTUELL` enum('0','1') NOT NULL,
  ...
  `KASSEN_NAME` varchar(50) NOT NULL,
  `KASSEN_VERWALTER` varchar(50) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  ...
  `KASSEN_ID` int(4) NOT NULL,
  `ZAHLUNGSTYP` enum('Einnahmen','Ausgaben') NOT NULL,
  `BETRAG` decimal(10,2) NOT NULL,
  `DATUM` date NOT NULL,
  `BELEG_TEXT` varchar(200) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  `KOSTENTRAEGER_TYP` varchar(30) DEFAULT NULL,
...
(9, 8, 'Sonstige Ausgaben', '1');"
  ...
  `WEITER_VERWENDEN` enum('0','1') NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  ...
  `ID` int(7) NOT NULL,
  `PERSON_ID` int(7) NOT NULL,
  `ZUGRIFF_OBJ` varchar(30) NOT NULL,
  ...
  `LAGER_VERWALTER` varchar(50) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  ...
  `L_ID` int(7) NOT NULL,
  `DATUM` date NOT NULL,
  `LI_TYP` varchar(50) NOT NULL,
  `LI_ID` int(7) NOT NULL,
  `EMPF_TYP` varchar(50) NOT NULL,
  ...
  `KOSTENTRAEGER_TYP` varchar(50) NOT NULL,
  `KOSTENTRAEGER_ID` int(11) NOT NULL,
  `KOSTENKATEGORIE` varchar(100) NOT NULL,
  `ANFANG` date NOT NULL,
  `ENDE` date NOT NULL,
  `MWST_ANTEIL` decimal(10,2) NOT NULL,
  `BETRAG` decimal(10,2) NOT NULL,
  `MIETENTWICKLUNG_AKTUELL` enum('0','1') NOT NULL,
  ...
  `DAT` int(7) NOT NULL AUTO_INCREMENT,
  `JAHR` varchar(4) NOT NULL DEFAULT '2015',
...
(376, '2015', 'L8', '8.11', '9.14', '11.24');"
  ...
  `EINHEIT_ID` int(11) NOT NULL,
  `MIETVERTRAG_AKTUELL` enum('0','1') NOT NULL,
  ...
  `OBJEKT_ID` int(11) NOT NULL,
  `OBJEKT_AKTUELL` enum('0','1') NOT NULL,
  `OBJEKT_KURZNAME` varchar(20) NOT NULL,
...
(1, 1, 1, 'Hausverwaltung', '1');"
  ...
  `PERSON_NACHNAME` varchar(200) NOT NULL,
  `PERSON_VORNAME` varchar(200) NOT NULL,
  `PERSON_GEBURTSTAG` date NOT NULL,
  `PERSON_AKTUELL` enum('0','1') NOT NULL,
...
(1, 1, 'Mustermann', 'Max', '1900-01-01', '1');"
  ...
  `PERSON_MIETVERTRAG_AKTUELL` enum('0','1') NOT NULL,
  ...
  `KOSTENKONTO` varchar(10) NOT NULL,
  `KOS_TYP` varchar(100) NOT NULL,
  `KOS_ID` int(7) NOT NULL,
  `AUSSTELLER_TYP` varchar(100) NOT NULL,
  ...
  `PROTOKOLL_WER` varchar(50) NOT NULL,
  `PROTOKOLL_COMPUTER` varchar(50) NOT NULL,
  `PROTOKOLL_WANN` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `PROTOKOLL_TABELE` varchar(25) NOT NULL,
  ...
  `BELEG_NR` int(7) NOT NULL,
  `RECHNUNGSNUMMER` varchar(20) DEFAULT NULL,
  ...
  `AUSSTELLER_TYP` varchar(50) NOT NULL,
  `AUSSTELLER_ID` int(7) NOT NULL,
  `EMPFAENGER_TYP` varchar(50) NOT NULL,
  `EMPFAENGER_ID` int(7) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  `STATUS_ERFASST` enum('0','1') NOT NULL,
  `STATUS_VOLLSTAENDIG` enum('0','1') NOT NULL,
  `STATUS_ZUGEWIESEN` enum('0','1') NOT NULL,
  `STATUS_ZAHLUNG_FREIGEGEBEN` enum('0','1') NOT NULL,
  `STATUS_BEZAHLT` enum('0','1') NOT NULL,
  `STATUS_BESTAETIGT` enum('0','1') NOT NULL,
  ...
  `AUSSTELLER_TYP` varchar(30) NOT NULL,
  ...
  `M_ART` enum('EINMALIG','WIEDERKEHREND') NOT NULL,
  `NUTZUNGSART` enum('MIETZAHLUNG','RECHNUNGEN','HAUSGELD') NOT NULL,
  `EINZUGSART` enum('Aktuelles Saldo komplett','Nur die Summe aus Vertrag','Ratenzahlung') NOT NULL,
  `M_KOS_TYP` varchar(50) NOT NULL,
  ...
  `BENUTZER_TYP` varchar(30) NOT NULL,
  `BENUTZER_ID` int(7) NOT NULL,
  `VERFASSER_ID` int(7) NOT NULL,
  `ERLEDIGT` enum('0','1') NOT NULL,
  `AKUT` enum('JA','NEIN') NOT NULL,
  `KOS_TYP` varchar(50) NOT NULL,
  `KOS_ID` int(7) NOT NULL,
  ...
  `EINHEIT_KURZNAME` varchar(40) NOT NULL,
  `FM_Kurzname` varchar(40) NOT NULL,
  `FM_Einheitenname` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;"
        );
  ...
  `BETRAG` decimal(10,2) NOT NULL,
  `BETRAGS_ART` enum('Bruttobetrag','Nettobetrag','Skontobetrag') NOT NULL,
  `VZWECK1` varchar(27) NOT NULL,
  `VZWECK2` varchar(27) NOT NULL,
  `VZWECK3` varchar(27) NOT NULL,
  `BUCHUNGSTEXT` mediumtext,
  `ZAHLUNGSART` enum('VOLL','TEIL') NOT NULL,
  `BEZUGSTAB` enum('MIETVERTRAG','RECHNUNG') NOT NULL,
  `BEZUGS_ID` int(7) NOT NULL,
  `AUSZUGSNR` varchar(10) DEFAULT NULL,
  ...
  `AKTUELL` enum('0','1') NOT NULL,
  `ART` enum('Urlaub','Krank','oK','Auszahlung','Unbezahlt') NOT NULL,
  PRIMARY KEY (`U_DAT`),
  KEY `BENUTZER_ID` (`BENUTZER_ID`),
  KEY `ANTEIL` (`ANTEIL`),
  KEY `DATUM` (`DATUM`)
...
(26, 'Aufg.', 'Hausaufgang', '1');"
  ...
  `DAT` int(7) NOT NULL AUTO_INCREMENT,
  `PLAN_ID` int(7) NOT NULL,
  `PLAN_BEZEICHNUNG` varchar(50) NOT NULL,
  `INTERVALL` int(3) NOT NULL,
  `INTERVALL_PERIOD` enum('DAY','MONTH','YEAR') NOT NULL,
  `GEWERK_ID` int(7) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  PRIMARY KEY (`DAT`),
  KEY `PLAN_ID` (`PLAN_ID`)
  ...
  `ART` enum('Ausgaben/Einnahmen','Mittelverwendung','Verrechnung') NOT NULL,
  ...
  `DAT` int(7) NOT NULL AUTO_INCREMENT,
  `ID` int(7) NOT NULL,
  `KONTENRAHMEN_KONTO` varchar(20) NOT NULL,
  `IHR_GK_ID` int(7) NOT NULL,
  `DATUM` date NOT NULL,
  `BETRAG` decimal(10,2) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  ...
  `ENDE` date NOT NULL,
  `BETRAG` decimal(10,2) NOT NULL,
  `KOSTENKAT` varchar(100) NOT NULL,
  `E_KONTO` varchar(10) NOT NULL,
  `GRUPPE` varchar(100) NOT NULL,
  `G_KONTO` varchar(10) NOT NULL,
  `KOS_TYP` varchar(50) NOT NULL,
  `KOS_ID` int(7) NOT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  PRIMARY KEY (`DAT`)
  ...
  `ID` int(7) NOT NULL,
  `WPLAN_ID` int(7) NOT NULL,
  `KOSTENKONTO` varchar(20) NOT NULL,
  `BETRAG` decimal(10,2) NOT NULL,
  `BETRAG_VJ` decimal(10,2) NOT NULL,
  `FORMEL` varchar(50) NOT NULL,
  ...
  `LAGE_RAUM` varchar(50) NOT NULL,
  `KOSTENTRAEGER_TYP` varchar(50) NOT NULL,
  `KOSTENTRAEGER_ID` int(7) NOT NULL,
  `RECHNUNG_AN` mediumtext NOT NULL,
  ...
  `DAUER_MIN` varchar(3) NOT NULL,
  `GERAETE_ID` int(7) NOT NULL,
  `BENUTZER_ID` int(7) NOT NULL,
  `ABGESAGT` enum('0','1') DEFAULT NULL,
  `ABGESAGT_AM` date DEFAULT NULL,
  `ABGESAGT_VON` enum('Kunde','Wartungsfirma') DEFAULT NULL,
  `GRUND` varchar(200) DEFAULT '',
  `ABSAGE_AUFGENOMMEN` int(7) DEFAULT NULL,
  `ABSAGE_RECHTZEITIG` enum('0','1') DEFAULT NULL,
  `AKTUELL` enum('0','1') NOT NULL,
  PRIMARY KEY (`DAT`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 ;"
        );
