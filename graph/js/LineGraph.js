 ...
 *  LineGraph.js
 *
 *	This file is the default ECMAscript (JavaScript) for Line Graphs. It is used if no other script is specified.
	...
	/* set legend */ {
		...
		for(i=0; i<=20; i++) {
			...
			if(legendDataRow) {
				...
				set(legendDataRow, 'x1', 10);
				set(legendDataRow, 'y1', offset);
				set(legendDataRow, 'x2', 40);
				set(legendDataRow, 'y2', offset);
				set(text, 'x', 50);
				set(text, 'y', offset+5);
				offset += 26;
			}
