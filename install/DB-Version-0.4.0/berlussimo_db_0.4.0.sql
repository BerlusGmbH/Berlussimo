...
--
-- Host: localhost
-- Erstellungszeit: 19. November 2015 um 14:46
...
--
-- Tabellenstruktur für Tabelle `BAUSTELLEN_EXT`
--
...
--
-- Daten für Tabelle `BAUSTELLEN_EXT`
--
...
--
-- Tabellenstruktur für Tabelle `BAU_BELEG`
--
...
--
-- Tabellenstruktur für Tabelle `BELEG2RG`
--
...
--
-- Tabellenstruktur für Tabelle `BERICHTE_USER`
--

CREATE TABLE IF NOT EXISTS `BERICHTE_USER`(
...
--
-- Daten für Tabelle `BERICHTE_USER`
--
...
CREATE TABLE IF NOT EXISTS `BK_ABRECHNUNGEN`(
                                              `B_DAT`            int(6)                                    NOT NULL AUTO_INCREMENT,
                                              `B_ID`             int(6)                                    NOT NULL,
                                              `PROFIL_ID`        int(6)                                    NOT NULL,
                                              `PROFIL_BEZ`       varchar(100) COLLATE utf8mb4_unicode_ci   NOT NULL,
                                              `PROFIL_JAHR`      int(4)                                    NOT NULL,
                                              `WIRT_E`           int(6)                                    NOT NULL,
                                              `WIRT_NAME`        varchar(100) COLLATE utf8mb4_unicode_ci   NOT NULL,
                                              `DATUM`            date                                      NOT NULL,
                                              ...
                                              `ANZ_ABRECHNUNGEN` varchar(6) COLLATE utf8mb4_unicode_ci     NOT NULL,
                                              `ERSTELLT`         timestamp                                 NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                                              `ERSTELLER`        varchar(30) COLLATE utf8mb4_unicode_ci    NOT NULL,
...
CREATE TABLE IF NOT EXISTS `FEIERTAGE`(
                                        ...
                                        `DATUM`    date                                      NOT NULL,
                                        `FEIERTAG` varchar(50) COLLATE utf8mb4_unicode_ci    NOT NULL,
                                        `AKTUELL`  enum ('0','1') COLLATE utf8mb4_unicode_ci NOT NULL,
                                        PRIMARY KEY (`F_DAT`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
--
-- Tabellenstruktur für Tabelle `FENSTER_EINGEBAUT`
--
...
--
-- Daten für Tabelle `FENSTER_EINGEBAUT`
--
...
--
-- Tabellenstruktur für Tabelle `FENSTER_LIEFERUNG`
--
...
--
-- Daten für Tabelle `FENSTER_LIEFERUNG`
--
...
--
-- Tabellenstruktur für Tabelle `GEO_ENTFERNUNG`
--
...
--
-- Daten für Tabelle `GEO_ENTFERNUNG`
--
...
--
-- Tabellenstruktur für Tabelle `GEO_LON_LAT`
--
...
--
-- Tabellenstruktur für Tabelle `GEO_TERMINE`
--
...
--
-- Tabellenstruktur für Tabelle `KUNDEN_LOGFILE`
--

CREATE TABLE IF NOT EXISTS `KUNDEN_LOGFILE`(
                                             `DAT`   int(7)                                 NOT NULL AUTO_INCREMENT,
                                             `USER`  varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
                                             `IP`    varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
                                             `HOST`  varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
                                             `AGENT` tinytext COLLATE utf8mb4_unicode_ci    NOT NULL,
...
--
-- Daten für Tabelle `KUNDEN_LOGFILE`
--
...
--
-- Tabellenstruktur für Tabelle `KUNDEN_LOGIN`
--
...
--
-- Daten für Tabelle `KUNDEN_LOGIN`
--
...
--
-- Tabellenstruktur für Tabelle `KUNDEN_LOG_BER`
--
...
--
-- Daten für Tabelle `KUNDEN_LOG_BER`
--
...
--
-- Tabellenstruktur für Tabelle `LEERSTAND_INTERESSENT`
--

CREATE TABLE IF NOT EXISTS `LEERSTAND_INTERESSENT`(
...
--
-- Daten für Tabelle `LEERSTAND_INTERESSENT`
--
...
CREATE TABLE IF NOT EXISTS `LIEFERSCHEINE_OK`(
                                               `L_DAT`    int(7)                                    NOT NULL AUTO_INCREMENT,
                                               `L_ID`     int(7)                                    NOT NULL,
                                               `DATUM`    date                                      NOT NULL,
                                               `LI_TYP`   varchar(50) COLLATE utf8mb4_unicode_ci    NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LV_GLIEDERUNG`(
...
CREATE TABLE IF NOT EXISTS `LV_K_ARTIKEL`(
...
CREATE TABLE IF NOT EXISTS `LV_K_POSITIONEN`(
...
CREATE TABLE IF NOT EXISTS `LV_POSITIONEN`(
                                            ...
                                            `P_ID`           int(7)                                 NOT NULL,
                                            `A_ID`           int(7)                                 NOT NULL,
                                            `ARTIKEL_NR`     varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LV_PROJEKTE`(
                                          `PROJEKT_ID` int(7)                                                                          NOT NULL AUTO_INCREMENT,
                                          `TEXT`       varchar(255) COLLATE utf8mb4_unicode_ci                                         NOT NULL,
                                          `AUTHOR`     varchar(20) COLLATE utf8mb4_unicode_ci                                          NOT NULL,
                                          `ART`        enum ('Altbau','Neubau','Sanierung','Teilsanierung') COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `MOB_ZE_PROTOKOLL`
--

CREATE TABLE IF NOT EXISTS `MOB_ZE_PROTOKOLL`(
                                               `DAT`        int(7)                                    NOT NULL AUTO_INCREMENT,
                                               `B_ID`       int(7)                                    NOT NULL,
                                               `KW`         int(2)                                    NOT NULL,
                                               ...
                                               `ABNAHME`    enum ('0','1') COLLATE utf8mb4_unicode_ci NOT NULL,
                                               `ABGENOMMEN` enum ('0','1') COLLATE utf8mb4_unicode_ci NOT NULL,
                                               `AKTUELL`    enum ('0','1') COLLATE utf8mb4_unicode_ci NOT NULL,
                                               PRIMARY KEY (`DAT`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
--
-- Daten für Tabelle `MOB_ZE_PROTOKOLL`
--
...
--
-- Tabellenstruktur für Tabelle `PARTNER_STICHWORT`
--
...
--
-- Daten für Tabelle `PARTNER_STICHWORT`
--
...
CREATE TABLE IF NOT EXISTS `PHP_ABFRAGEN`(
                                           `ABFRAGE_ID`   varchar(30) COLLATE utf8mb4_unicode_ci  NOT NULL,
                                           `KUERZEL`      varchar(30) COLLATE utf8mb4_unicode_ci  NOT NULL,
                                           `BESCHREIBUNG` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
                                           `SQL_ABFRAGE`  varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `POS_GRUPPE`
--
...
--
-- Tabellenstruktur für Tabelle `POS_POOL`
--
...
--
-- Tabellenstruktur für Tabelle `POS_POOLS`
--
...
--
-- Tabellenstruktur für Tabelle `RECHNUNGEN_SCHLUSS`
--
...
--
-- Daten für Tabelle `RECHNUNGEN_SCHLUSS`
--
...
--
-- Tabellenstruktur für Tabelle `SEPA_KONTOS`
--

CREATE TABLE IF NOT EXISTS `SEPA_KONTOS`(
                                          `DAT`           int(7)                                    NOT NULL AUTO_INCREMENT,
                                          `ID`            int(7)                                    NOT NULL,
                                          `IBAN`          varchar(35) COLLATE utf8mb4_unicode_ci    NOT NULL,
                                          `BIC`           varchar(11) COLLATE utf8mb4_unicode_ci    NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `SEPA_MANDATE`
--
...
--
-- Daten für Tabelle `SEPA_MANDATE`
--
...
--
-- Tabellenstruktur für Tabelle `SEPA_MANDATE_1_2_14`
--

CREATE TABLE IF NOT EXISTS `SEPA_MANDATE_1_2_14`(
                                                  `DAT`              int(7)                                                                                                  NOT NULL AUTO_INCREMENT,
                                                  `M_ID`             int(7)                                                                                                  NOT NULL,
                                                  `M_REFERENZ`       varchar(35) COLLATE utf8mb4_unicode_ci                                                                  NOT NULL,
                                                  `GLAEUBIGER_ID`    varchar(35) COLLATE utf8mb4_unicode_ci                                                                  NOT NULL,
...
--
-- Daten für Tabelle `SEPA_MANDATE_1_2_14`
--
...
--
-- Tabellenstruktur für Tabelle `SEPA_MANDATE_SEQ`
--
...
--
-- Daten für Tabelle `SEPA_MANDATE_SEQ`
--
...
--
-- Tabellenstruktur für Tabelle `SEPA_MANDATE_SEQ_03_frst`
--

CREATE TABLE IF NOT EXISTS `SEPA_MANDATE_SEQ_03_frst`(
                                                       `ID`         int(11)                                   NOT NULL AUTO_INCREMENT,
                                                       `M_REFERENZ` varchar(35) COLLATE utf8mb4_unicode_ci    NOT NULL,
                                                       `SEQ`        varchar(4) COLLATE utf8mb4_unicode_ci     NOT NULL,
                                                       `BETRAG`     decimal(10,2)                             NOT NULL,
...
--
-- Daten für Tabelle `SEPA_MANDATE_SEQ_03_frst`
--
...
--
-- Tabellenstruktur für Tabelle `SEPA_UEBERWEISUNG`
--
...
--
-- Daten für Tabelle `SEPA_UEBERWEISUNG`
--
...
--
-- Tabellenstruktur für Tabelle `SICH_EINBEHALT`
--
...
--
-- Daten für Tabelle `SICH_EINBEHALT`
--
...
--
-- Tabellenstruktur für Tabelle `START_STOP`
--
...
--
-- Stellvertreter-Struktur des Views `Thermen in 6 Monaten`
--
CREATE TABLE IF NOT EXISTS `Thermen in 6 Monaten` (
`GERAETE_ID` int(7)
,`EINBAUORT` varchar(50)
,`HERSTELLER` varchar(50)
,`BEZEICHNUNG` varchar(50)
,`KOSTENTRAEGER_TYP` varchar(50)
,`KOSTENTRAEGER_ID` int(7)
,`INTERVAL_M` int(3)
,`HEUTE` varchar(10)
,`L_WART_FAELLIG` varchar(10)
,`L_WART` date
);
-- --------------------------------------------------------

--
-- Stellvertreter-Struktur des Views `Thermen in 9 Monaten`
--
CREATE TABLE IF NOT EXISTS `Thermen in 9 Monaten` (
`GERAETE_ID` int(7)
,`EINBAUORT` varchar(50)
,`HERSTELLER` varchar(50)
,`BEZEICHNUNG` varchar(50)
...
--
-- Stellvertreter-Struktur des Views `UNI_ARTIKELL_PREIS`
--
CREATE TABLE IF NOT EXISTS `UNI_ARTIKELL_PREIS` (
`ARTIKEL_NR` varchar(20)
,`MENGE` decimal(10,2)
,`PREIS` decimal(10,4)
,`RABATT_SATZ` decimal(5,2)
);
-- --------------------------------------------------------
...
--
-- Tabellenstruktur für Tabelle `URLAUB_BELOW`
--

CREATE TABLE IF NOT EXISTS `URLAUB_BELOW`(
                                           `U_DAT`       int(7)                                                                      NOT NULL AUTO_INCREMENT,
                                           `BENUTZER_ID` int(7)                                                                      NOT NULL,
                                           `ANTRAG_D`    date DEFAULT NULL,
                                           `DATUM`       date                                                                        NOT NULL,
                                           `ANTEIL`      decimal(2,1)                                                                NOT NULL,
                                           `AKTUELL`     enum ('0','1') COLLATE utf8mb4_unicode_ci                                   NOT NULL,
                                           `ART`         enum ('Urlaub','Krank','Auszahlung','Unbezahlt') COLLATE utf8mb4_unicode_ci NOT NULL,
                                           PRIMARY KEY (`U_DAT`),
                                           KEY `BENUTZER_ID` (`BENUTZER_ID`),
                                           KEY `ANTEIL` (`ANTEIL`),
                                           KEY `DATUM` (`DATUM`)
...
--
-- Daten für Tabelle `URLAUB_BELOW`
--
...
CREATE TABLE IF NOT EXISTS `WARTUNG_ZUWEISUNG`(
                                                `DAT`        int(7)                                    NOT NULL AUTO_INCREMENT,
                                                `GERAETE_ID` int(7)                                    NOT NULL,
                                                `PLAN_ID`    int(7)                                    NOT NULL,
                                                `AKTUELL`    enum ('0','1') COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `WEG_EIGENTUEMER_PERSON`
--
...
--
-- Daten für Tabelle `WEG_EIGENTUEMER_PERSON`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_HGA_HK`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_HGA_PROFIL`
--
...
--
-- Daten für Tabelle `WEG_HGA_PROFIL`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_HGA_ZEILEN`
--
...
--
-- Daten für Tabelle `WEG_HGA_ZEILEN`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_HG_ZAHLUNGEN`
--
...
--
-- Daten für Tabelle `WEG_HG_ZAHLUNGEN`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_IHR_III`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_KONTOSTAND`
--
...
--
-- Daten für Tabelle `WEG_KONTOSTAND`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_MITEIGENTUEMER`
--
...
--
-- Daten für Tabelle `WEG_MITEIGENTUEMER`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_WG_DEF`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_WPLAN`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_WPLAN_ZEILEN`
--
...
--
-- Daten für Tabelle `WEG_WPLAN_ZEILEN`
--
...
--
-- Tabellenstruktur für Tabelle `WEG_WPLAN_ZEILEN1_ALT`
--

CREATE TABLE IF NOT EXISTS `WEG_WPLAN_ZEILEN1_ALT`(
                                                    `DAT`         int(7)                                    NOT NULL AUTO_INCREMENT,
                                                    `ID`          int(7)                                    NOT NULL,
                                                    `WPLAN_ID`    int(7)                                    NOT NULL,
                                                    `KOSTENKONTO` varchar(20) COLLATE utf8mb4_unicode_ci    NOT NULL,
...
--
-- Daten für Tabelle `WEG_WPLAN_ZEILEN1_ALT`
--
...
--
-- Tabellenstruktur für Tabelle `WERKZEUGE`
--
...
--
-- Stellvertreter-Struktur des Views `W_GERAETE doppelt`
--
CREATE TABLE IF NOT EXISTS `W_GERAETE doppelt` (
`COUNT(LAGE_RAUM)` bigint(21)
,`LAGE_RAUM` varchar(50)
,`PARTNER_NAME` mediumtext
);
-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `W_GRUPPE`
--
...
--
-- Tabellenstruktur für Tabelle `W_TEAMS`
--
...
--
-- Tabellenstruktur für Tabelle `W_TEAMS_BENUTZER`
--
...
--
-- Daten für Tabelle `W_TEAMS_BENUTZER`
--
...
--
-- Tabellenstruktur für Tabelle `W_TEAM_PROFILE`
--
...
--
-- Daten für Tabelle `W_TEAM_PROFILE`
--
...
--
-- Struktur des Views `Thermen in 6 Monaten`
--
DROP TABLE IF EXISTS `Thermen in 6 Monaten`;
...
--
-- Struktur des Views `Thermen in 9 Monaten`
--
DROP TABLE IF EXISTS `Thermen in 9 Monaten`;
...
--
-- Struktur des Views `UNI_ARTIKELL_PREIS`
--
DROP TABLE IF EXISTS `UNI_ARTIKELL_PREIS`;
...
--
-- Struktur des Views `W_GERAETE doppelt`
--
DROP TABLE IF EXISTS `W_GERAETE doppelt`;
