    ...
    function pdf_bericht_se($objekt_id, $monat, $jahr, $lang = 'de')
    {
        ...
        if (is_array($ein_arr)) {
            ...
            for ($a = 0; $a < $anz_e; $a++) {
                ...
                $ein_arr [$a] ['BUCHUNGEN'] = $this->bebuchte_konten(session()->get('geldkonto_id'), $einheit_id, $monat, $jahr, $et_id, $mv_id);
            }
        }
        ...
        for ($m = 0; $m < $anz_m; $m++) {
            ...
            if (is_array($arr [$m] ['HAUSGELD'])) {
                ...
                for ($hg = 0; $hg < $anz_hg; $hg++) {
                    ...
                    if ($this->check_vg(session()->get('geldkonto_id'), $monat, $jahr, $et_id, $hg_betrag, null, null) == '0') {
                        $pdf->ezSetDy(12);
                        $pdf->ezSetMargins(135, 70, 50, 50);
                        $hg_betrag_a1 = nummer_punkt2komma_t($hg_betrag);
                        $pdf->ezText("$hg_betrag_a1 EUR", 10, array(
