...
class personen
{
	...
	WHERE (LTRIM( RTRIM( REPLACE( name, CHAR( 13, 10 ) ,  '' ) ) ) LIKE  '$nachname' && LTRIM( RTRIM( REPLACE( first_name, CHAR( 13, 10 ) ,  '' ) ) ) LIKE  '$vorname'
) OR 
(LTRIM( RTRIM( REPLACE( name, CHAR( 13, 10 ) ,  '' ) ) ) LIKE  '$vorname' && LTRIM( RTRIM( REPLACE( first_name, CHAR( 13, 10 ) ,  '' ) ) ) LIKE  '$nachname'
)
LIMIT 0 , 30";
