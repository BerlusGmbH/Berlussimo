    ...
    function dtaus_dateien_anzeigen($g_konto_id)
    {
        ...
        if (!is_array($dtaus_id_arr)) {
            ...
            for ($a = 0; $a < $anzahl_zeilen; $a++) {
                ...
                $pdf_link = "<a href=\"?daten=ueberweisung&option=dtaus_ansicht_pdf&dtaus_id=$dtaus_id\"><img src=\"images/pdf_light.png\"></a>";
                $pdf_link1 = "<a href=\"?daten=ueberweisung&option=dtaus_ansicht_pdf&dtaus_id=$dtaus_id&no_logo\"><img src=\"images/pdf_dark.png\"></a>";
