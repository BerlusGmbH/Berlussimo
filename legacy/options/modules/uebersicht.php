...
} elseif (request()->has('mietvertrag_id')) {
...
function uebersicht_einheit($einheit_id)
{
    ...
    echo "<hr><a href='" . route('legacy::todo::index', ['option' => 'auftrag_haus', 'haus_id' => $e->haus_id, 'einheit_id' => $einheit_id]) . "'>Aufträge an Haus</a><hr>";
    ...
    $link_objekt_details = "<a href='" . route('legacy::details::index', ['option' => 'details_anzeigen', 'detail_hinzu' => 'OBJEKT', 'detail_id' => $e->objekt_id]) . "'>NEUES DETAIL ZUM OBJEKT $e->objekt_name</a>";
    ...
    for ($i = 0; $i < $mv->anzahl_personen; $i++) {
        ...
        $link_person_details = "<a href='" . route('legacy::details::index', ['option' => 'details_hinzu', 'detail_tabelle' => 'PERSON', 'detail_id' => $akt_person_id]) . "'>NEUES DETAIL ZU $person_info->person_nachname $person_info->person_vorname</a>";
    ...
    echo "<hr><a href='" . route('legacy::mietvertraege::index', ['mietvertrag_raus' => 'mietvertrag_kurz', 'einheit_id' => $einheit_id]) . "'>Alle Mietverträge von $e->einheit_kurzname</a>";
    // echo "<pre>";
    ...
    if (!empty ($mietvertrag_id)) {
        echo "<b><a href='" . route('legacy::mietkontenblatt::index', ['anzeigen' => 'mietkonto_uebersicht_detailiert', 'mietvertrag_id' => $mietvertrag_id]) . "'>MIETKONTENBLATT</a></b><br>";
        echo "<b><a href='" . route('legacy::mietkontenblatt::index', ['anzeigen' => 'mietkonto_ab', 'mietvertrag_id' => $mietvertrag_id]) . "'>MIETKONTENBLATT AB</a></b><br>";
    }
    ...
    if (!empty ($mv->mietvertrag_bis)) {
        ...
        if ($mietvertrag_bis_datum == '00.00.0000') {
            ...
            echo "<a href='" . route('legacy::mietvertraege::index', ['mietvertrag_raus' => 'mietvertrag_beenden', 'mietvertrag_id' => $mietvertrag_id]) . "'>VERTRAG BEENDEN</a><br>";
        } else {
    ...
    $link_mv_details = "<a href='" . route('legacy::details::index', ['option' => 'details_hinzu', 'detail_tabelle' => 'MIETVERTRAG', 'detail_id' => $mietvertrag_id]) . "'>NEUES DETAIL ZUM MIETVERTRAG</a>";
    ...
    echo "<a href='" . route('legacy::kautionen::index', ['option' => 'kautionen_buchen', 'mietvertrag_id' => $mietvertrag_id]) . "'>Kautionen buchen</a><hr>";
    echo "<a href='" . route('legacy::kautionen::index', ['option' => 'hochrechner', 'mietvertrag_id' => $mietvertrag_id]) . "'>Kautionshöhe hochrechnen</a><hr>";
    ...
    $link_neuer_auftrag_int = "<a href='" . route('legacy::todo::index', ['option' => 'neues_projekt', 'typ' => 'Benutzer', 'kos_typ' => 'Einheit', 'kos_id' => $einheit_id]) . "'>Neuer Auftrag INT</a>";
    $link_neuer_auftrag_ext = "<a href='" . route('legacy::todo::index', ['option' => 'neues_projekt', 'typ' => 'Partner', 'kos_typ' => 'Einheit', 'kos_id' => $einheit_id]) . "'>Neuer Auftrag EXT</a>";
...
function uebersicht_einheit_alt($einheit_id)
{
    ...
    echo "<hr><a href='" . route('legacy::mietvertraege::index', ['mietvertrag_raus' => 'mietvertrag_kurz', 'einheit_id' => $einheit_id]) . "'>Alle Mietverträge von $einheit_kurzname</a>";
    echo "</div>";
    ...
    if (!empty ($mietvertrag_id)) {
        ...
        if (!empty ($mietvertrag_id)) {
            echo "MIETKONTENBLATT: <b><a href='" . route('legacy::mietkontenblatt::index', ['anzeigen' => 'mietkonto_uebersicht_detailiert', 'mietvertrag_id' => $mietvertrag_id]) . "'>MIETKONTO $einheit_kurzname</a></b><br>";
        }
