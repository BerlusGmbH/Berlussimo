<div class="row">
    <div class='col-xs-6'>
        ...
        <div class="row">
            ...
            <div class='col-xs-12 col-md-6 col-lg-4'>
                <a href='<?php echo route('web::rechnungen::legacy', ['option' => 'sepa_druckpool']) ?>'>SEPA aus
                    Rechnung</a>
            </div>
        </div>
    </div>
    ...
    <div class='col-xs-6 col-md-4'>
        ...
        <div class="row">
            ...
            <div class='col-xs-12 col-lg-6'>
                <a href='<?php echo route('web::rechnungen::legacy', ['option' => 'rg_aus_beleg']) ?>'>Rechnung aus
                    Beleg</a>
            </div>
        </div>
    </div>
