            ...
            <template slot="items" slot-scope="props">
                ...
                <td class="text-xs-right">
                    <div style="display: flex">
                        <b-detail-edit-dialog :loading.sync="loading"
                                              :parent="parent"
                                              :show.sync="showEdit[props.index]"
                                              :value="props.item"
                                              @input="saveDetail($event, props.index)"
                                              large
                                              prepend-icon="mdi-table"
                        >
                            <v-icon @click.stop="$set(showEdit, props.index, true)" style="cursor: pointer">
                                mdi-pencil
                            </v-icon>
                        </b-detail-edit-dialog>
                        <v-icon @click.stop="$set(showDelete, props.index, true)" style="cursor: pointer">mdi-delete
                        </v-icon>
                        <b-detail-delete-dialog :detail="props.item" @delete="deleteDetail(props.item)"
                                                v-model="showDelete[props.index]"
