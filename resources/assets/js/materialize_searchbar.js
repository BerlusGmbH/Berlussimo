            ...
            var search = function (query) {
                return $.getJSON("/api/v1/search?q=" + query).done(function (data) {
                    ...
                    if ($.isArray(data['objekte']) && !$.isEmptyObject(data['objekte'])) {
                        $items.push($("<li class='primary-color text-variation-2'><a tabindex='-1' class='active-alternative primary-color text-variation-2' href='" + objektlisturl + query + "'>Objekte<span class='new badge' data-badge-caption=''>" + data['objekte'].length + "</span></a></li>"));
                    ...
                    if ($.isArray(data['haeuser']) && !$.isEmptyObject(data['haeuser'])) {
                        $items.push($("<li class='primary-color text-variation-2'><a tabindex='-1' class='active-alternative primary-color text-variation-2' href='" + hauslisturl + query + "'>Häuser<span class='new badge' data-badge-caption=''>" + data['haeuser'].length + "</span></a></li>"));
                    ...
                    if ($.isArray(data['einheiten']) && !$.isEmptyObject(data['einheiten'])) {
                        $items.push($("<li class='primary-color text-variation-2'><a tabindex='-1' class='active-alternative primary-color text-variation-2' href='" + einheitlisturl + query + "'>Einheiten<span class='new badge' data-badge-caption=''>" + data['einheiten'].length + "</span></a></li>"));
                    ...
                    if ($.isArray(data['personen']) && !$.isEmptyObject(data['personen'])) {
                        $items.push($("<li class='primary-color text-variation-2'><a tabindex='-1' class='active-alternative primary-color text-variation-2' href='" + personlisturl + query + "'>Personen<span class='new badge' data-badge-caption=''>" + data['personen'].length + "</span></a></li>"));
                    ...
                    if ($.isArray(data['partner']) && !$.isEmptyObject(data['partner'])) {
                        $items.push($("<li class='primary-color text-variation-2'><a tabindex='-1' class='active-alternative primary-color text-variation-2' href='" + partnerlisturl + query + "'>Partner<span class='new badge' data-badge-caption=''>" + data['partner'].length + "</span></a></li>"));
