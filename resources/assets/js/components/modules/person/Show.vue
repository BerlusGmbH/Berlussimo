<template>
    <v-container fluid>
        <v-layout row wrap>
            <v-flex xs12 sm6>
                <app-person-card v-if="person" :person="person"></app-person-card>
            </v-flex>
            ...
            <v-flex v-if="person && person.common_details.length > 0" xs12 sm6>
                <app-details-card headline="Details" :details="person.common_details"></app-details-card>
            </v-flex>
            ...
            <v-flex v-if="person && person.jobs_as_employee.length > 0" xs12 sm6>
                <app-jobs-card headline="Anstellungen" :jobs="person.jobs_as_employee"></app-jobs-card>
            </v-flex>
