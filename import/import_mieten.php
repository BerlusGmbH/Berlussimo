 ...
 * 
 * @filesource   $HeadURL: http://192.168.2.52/svn/berlussimo_1/tags/02.11.2010 - Downloadversion 0.27/import/import_mieten.php $
 * @version      $Revision: 6 $
...
function teilnahme_einzug_hinzu($mv_id, $kontoinhaber, $kontonummer, $blz, $bankname, $einzugsart) {
	...
	/* Einzugserm JA */
	$db_abfrage = "INSERT INTO DETAIL VALUES (NULL, '$letzte_tab_id', 'Einzugserm�chtigung', 'JA', '', '1', 'MIETVERTRAG', '$mv_id')";
	echo "<br>DB = $db_abfrage<br>";
	$resultat = mysql_query ( $db_abfrage ) or die ( mysql_error () );
